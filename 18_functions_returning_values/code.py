...
add(5, 8)
result = add(5, 8)
print(result)  # None - which is a value in python that means no value/missing value/undeclared value

#Functions by default will return None, you need to specify a return in your function
